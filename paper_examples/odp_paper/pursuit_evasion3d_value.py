...
po2 = PlotOptions(do_plot=True, plot_type="set", plotDims=[0,1,2],
                  slicesCut=[], save_fig=True, filename=f"{current_directory}/hj_figures/pursuit_evasion3d.png")
...
result = HJSolver(dynamics_obj=my_car,
                  grid=grid,
                  multiple_value=Initial_value_f,
                  tau=tau,
                  compMethod=compMethods,
                  saveAllTimeSteps=saveAllTimeSteps)
