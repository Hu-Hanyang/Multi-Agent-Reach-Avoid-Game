...
ttr_value = np.load(f"{current_directory}/hj_values/dubins4d_ttr2.npy")
...
plot_value_contour(grid, ttr_value, [0, 1], {2: 0.1, 3: math.pi/2}, save_dir=f'{current_directory}/hj_figures/',linewidth=3.5, linestyle='-', contour_linewidth=0.5, contour_linestyle=':',)
