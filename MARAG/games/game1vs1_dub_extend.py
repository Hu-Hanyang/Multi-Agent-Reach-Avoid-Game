...
from MARAG.dub_controllers import hj_contoller_attackers_dub, hj_contoller_defenders_dub_1vs1
from MARAG.plots_dub import check_current_value_dub, plot_value_1vs1_dub, animation_dub
...
start = time.time()
value1vs0_dub_extend = np.load('MARAG/values/DubinCar1vs0_grid100_medium_0.4angularv_20hz_1.0map.npy')
# value1vs1_dub_extend = np.load('MARAG/values/DubinCar1vs1_grid28_medium_0.4angularv_ctrl20hz_1.0map.npy')
value1vs1_dub_extend = np.load('MARAG/values/DubinCar1vs1_grid28_medium_1.0angularv_ctrl20hz_1.0map.npy')
