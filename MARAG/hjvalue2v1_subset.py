...
#     np.save('/localhome/hha160/optimized_dp/MARAG/2v1AttackDefend_new_step{}.npy'.format(i), at_least_one_win_2v1)
...
# np.save('/localhome/hha160/optimized_dp/MARAG/2v1AttackDefend.npy', at_least_one_win_2v1)
