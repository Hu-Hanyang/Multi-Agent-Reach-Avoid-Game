...
# value1v1 = np.load('MARAG/1v1AttackDefend.npy')
value1v1 = np.load('MARAG/1v1AttackDefend_g45_dspeed1.5.npy')  # grid = 45
# value2v1 = np.load('MARAG/2v1AttackDefend.npy')
# value2v1 = np.load('2v1AttackDefend_subset.npy')  # the subset one
value2v1 = np.load('MARAG/2v1AttackDefend_speed15.npy')  # the one we use in paper
...
# value1v0 = np.load('MARAG/1v0AttackDefend.npy')
