...
RA_1v1 = np.load(f"MARAG/values/1vs1AttackDefend_g{grid_size}_dspeed{speed_d}.npy") 
...
np.save(f'MARAG/values/1vs2AttackDefend_g{grid_size}_dspeed{speed_d}.npy', result)
