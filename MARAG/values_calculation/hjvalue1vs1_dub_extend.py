...
from MARAG.plots_dub import plot_value_1vs1_dub
# Plot options
...
# 6. Save the value function
np.save(f'MARAG/values/DubinCar1vs1_grid{grid_size}_{accuracy}_{angularv}angularv_ctrl{ctrl_freq}hz_{boundary}map.npy', result)
