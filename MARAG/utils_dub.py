...
def hj_preparations_sig():
    ...
    # value1vs2 = np.load('MARAG/values/1vs2AttackDefend_g35_dspeed1.5.npy')
    # value1vs2 = np.load('MARAG/values/1vs2AttackDefend_g35_dspeed1.5_defender.npy')
    value1vs2 = np.load('MARAG/values/1vs2AttackDefend_g35_dspeed1.5_defender2.npy')
    end = time.time()
...
def hj_preparations_dub():
    ...
    value1vs1_dub = np.load('MARAG/values/DubinCar1vs1_grid26_medium.npy')
    end = time.time()
    print(f"============= HJ value functions loaded Successfully! (Time: {end-start :.4f} seconds) =============")
